...
with dai.Device(pipeline) as device:
    ...
    while (True):
        ...
        heightA, widthA, channelA = camA_frame.shape
        heightB, widthB, channelB = camB_frame.shape
        heightC, widthC, channelC = camC_frame.shape
    ...
    print(f"Width: {widthA}, Height: {heightA}")
    print(f"Width: {widthB}, Height: {heightB}")
    print(f"Width: {widthC}, Height: {heightC}")
