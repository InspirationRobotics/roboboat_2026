...
Spatial Tiny-yolo example
  ...
  Can be used for tiny-yolo-v3 or tiny-yolo-v4 networks. This edited version should HOPEFULLY allow functionality with yolov8
  and the Perception files
'''
...
#TODO: Replace with labels of objects we've trained on, e.g. cross, dock, boat, buoy, etc.
labelMap = ['cross']
#e.g labelMap = [
...
stereo.setOutputSize(colorLeft.getResolutionWidth(), colorLeft.getResolutionHeight())
